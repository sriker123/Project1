var myapp = angular.module("myapp", []).controller(
		...
		function($scope, $http) {
			...
			$scope.getAllProducts = function() {
				...
				$http.get('http://localhost:6060/SCFE1/getProductsList').success(function(data) {
					$scope.products = data;
				})
			}
			...
			$scope.addToCart = function(productId) {
				...
				$http.put('http://localhost:6060/SCFE1/cart/add/'+ productId).success(function() {
			...
			$scope.refreshCart = function(cartId) {
				...
				$http.get('http://localhost:6060/SCFE1/cart/getCart/'
			...
			$scope.removeFromCart = function(cartItemId) {
				$http.put(
						'http://localhost:6060/SCFE1/cart/removecartitem/'
			...
			$scope.clearCart = function(cartId) {
				$http.put('http://localhost:6060/SCFE1/cart/removeAllItems/'+ cartId).success(function() {
					$scope.refreshCart($scope.cartId);
				});
			}
